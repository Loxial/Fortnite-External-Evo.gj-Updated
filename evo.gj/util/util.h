...
struct FTransform
{
	...
	void Print()
	{
		std::cout << "Rotation (FQuat): (" << rot.x << ", " << rot.y << ", " << rot.z << ", " << rot.w << ")\n";
		std::cout << "Translation (Vector3): (" << translation.x << ", " << translation.y << ", " << translation.z << ")\n";
		std::cout << "Scale (Vector3): (" << scale.x << ", " << scale.y << ", " << scale.z << ")\n";
	}
};
